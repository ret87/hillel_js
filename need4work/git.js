...
// Осуществлять только с локальными ветками, теми которые ещё не были запушены на удалённый репозиторий, незакоментированные изменения.
// - Перемещение применяет изменения из одной линии разработки в другую в том порядке, в котором они были представлены, 
// тогда как слияние объединяет вместе конечные точки двух веток. незакоментированные изменения.
// - Перемещение - все изменения из одной ветки по порядку повторить на другой, незакоментированные изменения.
// - Позволяет реализацию определённой ветки перебрасывать в любую часть кода (в другие ветки), незакоментированные изменения.
