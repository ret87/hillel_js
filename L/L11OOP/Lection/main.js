...
console.log(p);
console.log(d);
console.log(p.__proto__);       //покажет прототип Р
console.dir(Person.prototype.sleep(2,5));        // выведет сумму 2 и 5 через функцию со ссылкой прототипа 
console.dir(p.sleep === Person.prototype.sleep);    // тру, так как у них общий родитель
console.log(p.getPrivat());     //выведет значение приват, через функцию по ссылке прототипа
